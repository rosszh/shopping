...
<!--头部-->
  ...
  <!--//修改地址-->
  <div class="am-g am-text-center am-padding-horizontal-sm"><a href="<%=basePath %>client/shopsubmit" class="am-btn am-btn-danger col-sm-12">下一步&nbsp;<i class="am-icon-arrow-circle-right"></i></a></div>