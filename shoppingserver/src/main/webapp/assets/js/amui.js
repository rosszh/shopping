    ...
    var cookie = require("util.cookie"), modal = require("ui.modal"), $ = window.Zepto, footerInit = function() {
        ...
        $('[data-rel="desktop"]').on("click", function(e) {
            ...
            if (window.AMPlatform) {
                ...
                // back end
                cookie.set("allmobilize", "desktop", "", "../default.htm");
...
define("map", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    ...
    function addMapApi(callback) {
        var $mapApi0 = $("<script/>", {
            src: "../../api.map.baidu.com/getscript@type=quick&file=api&ak=WVAXZ05oyNRXS5egLImmentg&t=20140109092002"
        });
        $("body").append($mapApi0);
        $mapApi0.on("load", function() {
            var $mapApi1 = $("<script/>", {
                src: "../../api.map.baidu.com/getscript@type=quick&file=feature&ak=WVAXZ05oyNRXS5egLImmentg&t=20140109092002"
            });
            $("body").append($mapApi1);
    ...
    function addBdMap() {
        ...
        name = content.getAttribute("data-name"), address = content.getAttribute("data-address") , telephone = content.getAttribute("data-telephone") , lng = content.getAttribute("data-longitude") || defaultLng, lat = content.getAttribute("data-latitude") || defaultLat;
        ...
        // 创建信息窗口对象
        var infoWindow = new BMap.InfoWindow("地　址:" + address + "<br/>电　话:" + telephone , opts);
        // 创建地址解析器实例
...
define("navbar", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector", "util.qrcode", "ui.modal" ], function(require, exports, module) {
    ...
    var navbarInit = function() {
        ...
        if ($share.length) {
            ...
            $body.append($("<script />", {
                src: "../../bdimg.share.baidu.com/static/api/js/share.js@v=89343201.js@cdnversion=" + ~(-new Date() / 36e5)
            }));
...
define("sohucs", [], function(require, exports, module) {
    ...
    var sohuCSInit = function() {
        ...
        var $sohucs = $('[data-am-widget="sohucs"]'), appid = $sohucs.attr("data-am-sohucs-appid"), conf = $sohucs.attr("data-am-sohucs-conf"), $cy = $("<script></script>", {
            ...
            src: "../../changyan.sohu.com/upload/mobile/wap-js/changyan_mobile.js@client_id=" + appid + "&conf=" + conf
        });
        $("body").append($cy);
    };
    // Lazy load
...
define("tabs", [ "zepto.extend.touch", "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    ...
    function amTabs(parent) {
        ...
        $tabLi.on("click", function() {
          ...
          $tabsContent.height($tabsDiv.eq(iNow).height());//by MR ding
        });
    }
    $(function() {
        tabsInit();
...
define("ui.modal", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector", "ui.dimmer" ], function(require, exports, module) {
    ...
    Modal.prototype.events = function() {
        ...
        $element.find(".am-modal-btn.modal-cancel").on("click.modal.amui", function(e) {
            that.close();
        });
